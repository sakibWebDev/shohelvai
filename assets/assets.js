...
// assets/assets.js
import { TruckIcon, RefreshCcwIcon, HeadsetIcon } from "lucide-react";

export const ourSpecsData = [
  { 
    title: "ফ্রি ডেলিভারি 🚚", 
    description: "বাংলাদেশের যেকোনো জায়গায় বিনামূল্যে ডেলিভারি পাবেন।", 
    icon: TruckIcon, 
    accent: '#16A34A' 
  },
  { 
    title: "সহজ রিটার্ন 🔄", 
    description: "পণ্য পছন্দ না হলে ৭ দিনের মধ্যে সহজে ফেরত দিতে পারবেন।", 
    icon: RefreshCcwIcon, 
    accent: '#65A30D' 
  },
  { 
    title: "২৪/৭ কাস্টমার সার্ভিস ☎️", 
    description: "চাষী ভাই সবসময় আপনার পাশে। যেকোনো প্রয়োজনে যোগাযোগ করুন।", 
    icon: HeadsetIcon, 
    accent: '#15803D' 
  }
];
